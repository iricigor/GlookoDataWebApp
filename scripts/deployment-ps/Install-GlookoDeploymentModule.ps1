...
if ($LocalPath) {
    ...
    $Files = @(
        ...
        @{ Path = "Public/Invoke-GlookoProUsers.ps1"; Dest = "Public" }
        @{ Path = "Public/Invoke-GlookoProviderMigration.ps1"; Dest = "Public" }
        ...
        @{ Path = "Public/Set-GlookoStaticWebApp.ps1"; Dest = "Public" }
