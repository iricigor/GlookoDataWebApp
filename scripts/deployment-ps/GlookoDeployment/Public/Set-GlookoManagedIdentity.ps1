...
function Set-GlookoManagedIdentity {
    ...
    process {
        try {
            ...
            Write-Host "  1. Create the Storage Account:  Set-GlookoStorageAccount"
            Write-Host "  2. Create the Key Vault:        Set-GlookoKeyVault"
            Write-Host "  3. Create the Function App:     Set-GlookoAzureFunction"
            Write-Host "  4. Assign RBAC roles to the identity as needed"
            Write-Host ""
