    ...
    process {
        try {
            ...
            try {
                ...
                # We use Azure CLI 'az staticwebapp backends show' to check backend linking.
                ...
                try {
                    ...
                    $backendOutput = az staticwebapp backends show `
                    ...
                    $issues += "Unable to verify backend linking"
                }
