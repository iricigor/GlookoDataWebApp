...
This directory contains Azure deployment scripts for the GlookoDataWebApp project with support for **managed identity** (secure, secret-free authentication) and **centralized configuration management**.
