...
display_summary() {
    ...
    echo ""
    echo "Next Steps:"
    echo "  1. Create the Storage Account:       ./deploy-azure-storage-account.sh"
    echo "  2. Create the Key Vault:             ./deploy-azure-key-vault.sh"
    echo "  3. Create the Function App:          ./deploy-azure-function.sh"
    echo "  4. Assign RBAC roles to the identity as needed"
    echo ""
