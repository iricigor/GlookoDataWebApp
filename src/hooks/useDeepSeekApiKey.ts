/**
 * Custom hook for managing DeepSeek API key
 * 
...
export interface UseDeepSeekApiKeyReturn {
  apiKey: string;
  setApiKey: (key: string) => void;
}

const API_KEY_COOKIE_NAME = 'glooko-deepseek-api-key';
...
/**
 * Hook to manage DeepSeek API key
 */
export function useDeepSeekApiKey(): UseDeepSeekApiKeyReturn {
