/**
 * Tests for useGeminiApiKey hook
 */
...
describe('useGeminiApiKey', () => {
  ...
  it('should initialize from cookie if it exists', () => {
    ...
    document.cookie = 'glooko-gemini-api-key=test-key-123; path=/; SameSite=Strict';
  ...
  it('should save to cookie when setApiKey is called', () => {
    ...
    const apiKeyCookie = cookies.find(c => c.trim().startsWith('glooko-gemini-api-key='));
