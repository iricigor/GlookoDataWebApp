/**
 * Custom hook for managing Grok API key
 * 
...
export interface UseGrokApiKeyReturn {
  apiKey: string;
  setApiKey: (key: string) => void;
}

const API_KEY_COOKIE_NAME = 'glooko-grok-api-key';
...
/**
 * Hook to manage Grok API key
 */
export function useGrokApiKey(): UseGrokApiKeyReturn {
